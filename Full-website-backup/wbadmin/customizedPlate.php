    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6 text-right">
         <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Customized Plate Orders</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
...
<section class="section profile"> 
  ...
  <?php
 $order_qry = db_query("SELECT a1.* FROM order_members as a1, order_detail as b1 WHERE a1.slno=b1.order_members_slno && b1.qryType='1' GROUP BY b1.order_members_slno order by a1.slno DESC");         
  if(db_num_rows($order_qry)>0) {
    ...
    <tr class="tr-text-white">         
      ...
      <th class="nowrap_space" width="25%">Contact Detail</th>
      <th class="nowrap_space" width="25%">Others Detail</th>
      <th class="nowrap_space" width="15%">Query Type</th>
      ...
      while($carr = db_fetch_assoc($order_qry)) {
        ...
        <tr class="ui-state-default" data-index="<?php echo $carr['slno']?>" data-position="<?php echo $carr['position']?>">
          ...
          Mobile No.: +91-<?php echo $carr['mobile_no'];?>          
          </td>
          ...
          <td>          
          <span class="text-danger"><?php echo $ereqArr['occasions_title']?></span><br>
          <?php echo $carr['qryType']?><br>
