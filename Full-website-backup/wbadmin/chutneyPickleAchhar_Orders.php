...
$metatitle ="Chutney Pickle / Achhar Orders";
include("header.php");
...
<section class="content-header mt-2">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h5>Chutney Pickle / Achhar Orders</h5>
      </div>
      <div class="col-sm-6 text-right">
         <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Chutney Pickle / Achhar Orders</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
...
<section class="section profile"> 
  ...
  <?php
  $order_qry = db_query("SELECT a1.* FROM order_members as a1, order_detail as b1 WHERE a1.slno=b1.order_members_slno && b1.qryType='3' GROUP BY b1.order_members_slno order by a1.slno DESC");        
  if(db_num_rows($order_qry)>0) {
    ...
    <tr class="tr-text-white">         
      ...
      ?>
      <div class="text-center text-danger" style="font-size:16px;">No Any order</div>
      <?php
    }
    ?>
  </div>       
