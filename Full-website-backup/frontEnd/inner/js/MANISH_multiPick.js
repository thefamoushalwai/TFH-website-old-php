        ...
        $(document).ready(function () {
            ...
            $(`#${id}`).find(`.option-item`).click(function (e) {                
                ...
                if ($(this).prop('id') !== 'search' && itens.length < settings.limit && same === false) {                    
                    $(`#${id}`).find(`.selected-itens`).append(`<div class="item" rdata-value="${value}">
                                                            ${imageblock}
                                                            ${text}
                    ...
                    //Slected Item Remove here START
                    ...
                    //Slected Item Remove here END
                }

                
                var getItem_id=$(this).attr('data-value');
                ItemIDArr.push(getItem_id);
                /*if ($.inArray(getItem_id, ItemIDArr) >= 0) {
                    var index = ItemIDArr.indexOf(getItem_id);
                    if (index > -1) {
                      ItemIDArr.splice(index, 1);
                    }
                } 
                else {
                    ItemIDArr.push(getItem_id);
                }*/
                $('.selectedItems').val(ItemIDArr);                
