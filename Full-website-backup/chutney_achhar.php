...
$metatitle='Chutney, Pickle and Achhar Services';
$metaDesc='';
$metaKeywords='';
...
<!-- MENU ITEMS -->
<section id="menu-item" style="padding-top: 20px;">
    <div class="menu-container">
    
    <!-- <div class="col-xl-12">	
	<h1 class="serv_head">Chutney, Pickle and Achhar Services</h1>
	</div> -->

    <h2  class="serv_head text-center"> Chutney, Pickle and Achhar Services</h2>
    <div class="text-center" style="font-size:18px;">
    <a class="ViewCart"> <span style="color: #bb731b">My Cart</span> <img src="<?php echo SITE_URL;?>/frontEnd/images/cart.png" width="25px" alt="">  <sup><span id="cart-item" style="font-size: 22px;"> (<?php echo $cartIVal;?>) </span></sup> 
